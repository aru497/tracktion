...
window.UI = (function () {
  ...
  const ICON = {
    ...
    kudos:   S('<path d="M7 11v9H4a1 1 0 0 1-1-1v-7a1 1 0 0 1 1-1h3z"/><path d="M7 11l4.2-7a2 2 0 0 1 3.6 1.2L14 9h4.4a2 2 0 0 1 2 2.4l-1.3 6.5A2.5 2.5 0 0 1 16.6 20H7"/>'),
    kudosF:  S('<path d="M7 11v9H4a1 1 0 0 1-1-1v-7a1 1 0 0 1 1-1h3zM7 11l4.2-7a2 2 0 0 1 3.6 1.2L14 9h4.4a2 2 0 0 1 2 2.4l-1.3 6.5A2.5 2.5 0 0 1 16.6 20H7z"/>', { fill: 'currentColor' }),
    comment: S('<path d="M21 12a8 8 0 0 1-8 8H4l2.3-2.7A8 8 0 1 1 21 12z"/>'),
